...
/**
 * 
 * 参考：https://blog.csdn.net/zhezhebie/article/details/80513499
 * 参考：http://svn.apache.org/repos/asf/httpd/httpd/trunk/docs/conf/mime.types
 *
 */
public class MIMEUtil {
    ...
    static {
        ...
        MIME_MAP.put("pls","application/pls+xml");
        ...
        MIME_MAP.put("mif","application/vnd.mif");
        ...
        MIME_MAP.put("exe","application/x-msdownload");
        ...
        MIME_MAP.put("z9","application/x-zmachine");
        ...
        MIME_MAP.put("ttc","font/collection");
        ...
        MIME_MAP.put("sub","image/vnd.dvb.subtitle");
